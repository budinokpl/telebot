...
[![GoDoc](https://godoc.org/github.com/budinokpl/telebot?status.svg)](https://godoc.org/github.com/budinokpl/telebot)
...
```bash
go get -u github.com/budinokpl/telebot
```
...
[here](https://godoc.org/github.com/budinokpl/telebot#pkg-constants).
...
implementations:
```go
import "github.com/budinokpl/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/budinokpl/telebot#Option).
